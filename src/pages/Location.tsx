...
export default function Location() {
  return (
    <div className="py-4 flex flex-col h-full">
      <SectionTitle title="Location" subtitle="How to reach the pandal." />
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="flex flex-col items-center p-4 glass rounded-xl">
          ...
          <span className="text-[10px] font-bold uppercase tracking-wider text-center">Parking Available</span>
        </div>
        <div className="flex flex-col items-center p-4 glass rounded-xl">
          <Droplets className="text-blue-400 mb-2" size={24} />
          <span className="text-[10px] font-bold uppercase tracking-wider text-center">Drinking Water</span>
        </div>
        <div className="flex flex-col items-center p-4 glass rounded-xl">
          <HeartPulse className="text-red-400 mb-2" size={24} />
          <span className="text-[10px] font-bold uppercase tracking-wider text-center">Medical Help</span>
        </div>
      </div>

      <SectionTitle title="Contact Us" subtitle="Reach out for queries." />
      <div className="space-y-3 pb-8">
        <Card className="!p-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-bold text-sm text-white/90">Phone</p>
              <p className="text-xs text-white/60">+91 98765 43210</p>
            </div>
          </div>
          <a href="tel:+919876543210" className="px-4 py-1.5 bg-white/10 rounded-full text-[10px] font-bold uppercase tracking-wider hover:bg-white/20 border border-white/10 transition-colors">Call</a>
        </Card>
        <Card className="!p-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="p-2 bg-emerald-500/20 text-emerald-400 rounded-full border border-emerald-500/20">
            ...
            <div>
              <p className="font-bold text-sm text-white/90">WhatsApp</p>
              <p className="text-xs text-white/60">Message Us</p>
            </div>
          </div>
          <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="px-4 py-1.5 bg-white/10 rounded-full text-[10px] font-bold uppercase tracking-wider hover:bg-white/20 border border-white/10 transition-colors">Chat</a>
        </Card>
      </div>
    </div>
  );
